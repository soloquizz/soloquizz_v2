    ...
    <div class="mdk-header-layout__content page-content">
        ...
        <div class="container page__container page-section">
            @foreach($editeurs as $editeur)
                @if(getEtudiantCertifications($editeur)->count()>0)
                    ...
                    <span class="mr-16pt">
                        ...
                        <span class="text-70">{{getEtudiantCertifications($editeur)->count()}} certifications</span>
                    </span>
                    </a>
                    <div class="card stack">
                        <div class="list-group list-group-flush">
                            @foreach(getEtudiantCertifications($editeur) as $certification)
