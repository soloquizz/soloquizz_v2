                            ...
                            <div class="">
                                <div class="form-row">
                                    <div class="col-12 col-md-6 mb-3">
                                        ...
                                        <input type="text" name="code" value="{{$certification->code}}" class="form-control" placeholder="010-160" required="">
                                    </div>
                                    <div class="col-12 col-md-6 mb-3">
                                        <label class="form-label">Titre
                                            <span class="text-danger">*</span>
                                        </label>
                                        <input type="text" name="titre" value="{{$certification->titre}}" class="form-control" placeholder="NDG LINUX Essential" required="">
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="col-12 col-md-6 mb-3">
