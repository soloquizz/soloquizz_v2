        ...
        <div class="container card bg-white page__container page-section mt-5">
            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <!-- Nombre d'éléments -->
                    <div class="col-sm-4">
                        <h4 class="content-header-title">Nombre de niveaux
                            <div class="badge badge-glow badge-pill badge-info">{{$niveaux->count()}}</div>
                        </h4>
                    </div>

                    <!-- Bouton -->
                    <div class="col-sm-4 text-right">
                        <a href="#" class="btn btn-outline-primary" data-toggle="modal" data-target="#addParcour">Nouveau
                            niveau</a>
                    </div>
                </div>
            </div>
