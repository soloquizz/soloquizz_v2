                            ...
                            <div class="">
                                <div class="form-row">
                                    <div class="col-12 col-md-6 mb-3">
                                        ...
                                        <input type="text" name="nom" value="{{$niveau->nom}}" class="form-control" placeholder="Licence 1" required="">
                                    </div>
                                    <div class="col-12 col-md-6 mb-3">
                                        <label class="form-label">Nombre d'années
                                            <span class="text-danger">*</span>
                                        </label>
                                        <input type="number" name="annee" value="{{$niveau->annee}}" class="form-control" placeholder="2" required="">
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="col-12 col-md-6 mb-3">
