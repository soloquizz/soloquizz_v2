...
@section('content_page')
    ...
    <div class="mdk-header-layout__content page-content">
        ...
        <div class="container card bg-white page__container page-section mt-5">
            {!! Form::model($editeur, ['route' => ['admin.editeurs.update', $editeur->id], 'method' => 'patch']) !!}
                            ...
                            <div class="">
                                <div class="form-row">
                                    <div class="col-12 col-md-6 mb-3">
                                        ...
                                        <input type="text" name="nom" class="form-control" value="{{$editeur->nom}}" placeholder="Python Institute" required="">
                                    </div>
                                </div>
                            </div>
                        </div>
