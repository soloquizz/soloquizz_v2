                            ...
                            <div class="">
                                <div class="form-row">
                                    <div class="col-12 col-md-6 mb-3">
                                        ...
                                        <input type="text" name="nom" class="form-control" value="{{$semestre->nom}}" placeholder="Semestre 1" required="">
                                    </div>
                                    <div class="col-12 col-md-6 mb-3">
                                        <label class="form-label">Numéro de la semestre
                                            <span class="text-danger">*</span>
                                        </label>
                                        <input type="number" name="numero" class="form-control" value="{{$semestre->numero}}" placeholder="2" required="">
                                    </div>
                                </div>
                            </div>
                        </div>
