        ...
        <div class="container card bg-white page__container page-section mt-5">
            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <!-- Nombre d'éléments -->
                    <div class="col-sm-4">
                        <h4 class="content-header-title">Nombre de domaines
                            <div class="badge badge-glow badge-pill badge-info">{{$domaines->count()}}</div>
                        </h4>
                    </div>

                    <!-- Bouton -->
                    <div class="col-sm-4 text-right">
                        <a href="#" class="btn btn-outline-primary" data-toggle="modal" data-target="#addDomaine">Nouveau
                            domaine</a>
                    </div>
                </div>
            </div>
