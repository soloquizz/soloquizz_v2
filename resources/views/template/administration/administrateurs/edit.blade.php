                            ...
                            <div class="">
                                <div class="form-row">
                                    <div class="col-12 col-md-6 mb-3">
                                        ...
                                        <input type="text" name="matricule" class="form-control" placeholder="matricule" value="{{$administrateur->matricule}}" required="">
                                    </div>
                                    <div class="col-12 col-md-6 mb-3">
                                        <label class="form-label">Prénom
                                            <span class="text-danger">*</span>
                                        </label>
                                        <input type="text" class="form-control" name="prenom" placeholder="Prénom" value="{{$administrateur->prenom}}" required="">
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="col-12 col-md-6 mb-3">
                                        ...
                                        <input type="text" name="nom" class="form-control" placeholder="nom" value="{{$administrateur->nom}}" required="">
                                    </div>
                                    <div class="col-12 col-md-6 mb-3">
                                        <label class="form-label" >Téléphone
                                            <span class="text-danger">*</span>
                                        </label>
                                        <input type="text" class="form-control" name="telephone" placeholder="Téléphone" value="{{$administrateur->telephone}}" required="">
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="col-12 col-md-6 mb-3">
                                        ...
                                        <input type="text" name="email_personnel" class="form-control" value="{{$administrateur->email_personnel}}" placeholder="Email Personnel">
                                    </div>
                                </div>
                            </div>
                        </div>
